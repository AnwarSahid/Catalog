                                        ...
                                        <tr>
                                            ...
                                            <td class="capitalize border px-4 py-2">
                                                @if ($item->LChkOut !== null && $item->LChkIn == null)
                                                    <span
                                                        class="hover:bg-yellow-600 text-white text-xs font-semibold bg-yellow-500 px-2 py-1 rounded-full">
                                                        Dipinjam
                                                    </span>
                                                @elseif($item->ItemStat == 'MIS')
                                                    <span
                                                        class="hover:bg-red-600 text-white text-xs font-semibold bg-red-700 px-2 py-1 rounded-full">
                                                        Tidak Tersedia
                                                    </span>
                                                ...
                                                @elseif($item->ItemStat == 'R')
                                                    <span
                                                        class="hover:bg-blue-600 text-white text-xs font-semibold bg-blue-500 px-2 py-1 rounded-full">
                                                        Sedang Diperbaiki
                                                    </span>
